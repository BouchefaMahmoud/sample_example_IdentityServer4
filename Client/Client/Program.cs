    ...
    class Program
    {
        ...
        static async Task MainAsync(string[] args)
        {
            ...
            if (apiResponse.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                {
                    // l'adresse du service de Tokens 
                    Address = "http://localhost:5000/connect/token",
                    /*
                     * ( GrantType = "password") est utilisé par les clients propriétaires pour échanger les informations 
                     * d'identification d'un utilisateur contre un jeton d'accès.
                     */
                     //TODO:  
                    GrantType = "password",
                ...
                //all good?
                 ...
                 /*
                     Après une authentification réussie, nous devrions avoir le AccessTokendans la réponse. 
                     Nous pouvons maintenant l'utiliser et l'ajouter en tant qu'AuthenticationHeader dans les DefaultRequestHeaders
                 */
